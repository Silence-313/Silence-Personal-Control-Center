...
const zh: Record<string, string> = {
  ...
  "page.observabilityDesc": "指标历史、系统健康度与自动化可观测性。",
  "section.metricsSummary": "指标摘要",
  "metricsSummary.samples": "{n} 个样本",
  "page.research": "研究",
  ...
  "page.knowledge": "知识",
  "page.knowledgeDesc": "自动索引的知识图谱 —— 项目、智能体、研究、会话与活动的关联视图。",
  "knowledge.searchPlaceholder": "搜索知识…",
  "knowledge.itemCount": "{count} 项",
  "knowledge.empty": "暂无知识条目。",
  "knowledge.relations": "关联",
  "knowledge.noRelations": "无关联",
  "knowledge.relatedProjects": "相关项目",
  "knowledge.relatedAgents": "相关智能体",
  "knowledge.relatedSessions": "相关会话",
  "knowledge.relatedResearch": "相关研究",
  "knowledge.relatedActivities": "相关活动",
  "knowledge.back": "返回知识库",
  "context.title": "上下文",
  "context.notFound": "未找到上下文",
  "context.title.notFound": "未找到上下文",
  "type.project": "项目",
  "type.agent": "智能体",
  "type.research": "研究项目",
  "type.paper": "论文",
